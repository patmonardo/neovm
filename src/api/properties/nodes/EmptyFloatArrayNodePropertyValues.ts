import { FloatArrayNodePropertyValues } from './FloatArrayNodePropertyValues'; // Assuming this interface exists
import { ValueType } from '../../ValueType'; // Adjusted path
 ...
 */
export class EmptyFloatArrayNodePropertyValues implements FloatArrayNodePropertyValues {
  /**
