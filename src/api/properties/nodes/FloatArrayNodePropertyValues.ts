...
import { ValueType } from '../../ValueType'; // Assuming ValueType is in @/api or similar path
 ...
 */
export interface FloatArrayNodePropertyValues extends NodePropertyValues {
  /**
   ...
   */
  valueType(): ValueType.FLOAT_ARRAY; // Using the specific enum member type for a stricter contract
